    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_DIALOG_SENT:
                ...
                LinearLayout.LayoutParams lpSent = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT, 1f);
            ...
            case TYPE_DIALOG_RECEIVED:
                ...
                LinearLayout.LayoutParams lpReceived = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT, 1f);
            ...
            case TYPE_MESSAGE_ERROR:
                ...
                LinearLayout.LayoutParams lpError = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
            ...
            case TYPE_MESSAGE_INFORMATION:
                ...
                LinearLayout.LayoutParams lpInfo = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
            ...
            case TYPE_MESSAGE_NOT_IMPLEMENTED:
                ...
                LinearLayout.LayoutParams lpCustom = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
